...
SELECT
    ...
    urban_area.species_in_birdlife_regional_pool AS regional_richness,
    ROUND(hotspot.project_richness / urban_area.species_in_birdlife_regional_pool * 100, 1) AS percentage_of_regional_richness
FROM
